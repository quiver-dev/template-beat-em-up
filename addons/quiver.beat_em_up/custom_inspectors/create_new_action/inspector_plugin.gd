...
func _add_node_to(node_to_add: QuiverCharacterAction, parent_node: Node) -> void:
...
func _remove_node_from(node_to_remove: QuiverCharacterAction, parent_node: Node) -> void:
	parent_node.remove_child(node_to_remove)


func _on_widget_add_node_to(node_to_add: QuiverCharacterAction, parent_node: Node) -> void:
