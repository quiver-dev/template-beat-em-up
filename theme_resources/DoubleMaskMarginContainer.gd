...
func _expand_margins() -> void:
	...
	add_theme_constant_override("margin_top", int(current_top_value + extra_margin_top))
	...
	add_theme_constant_override("margin_bottom", int(current_bottom_value + extra_margin_bottom))
